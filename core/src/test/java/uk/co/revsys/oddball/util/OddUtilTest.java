...
public class OddUtilTest {
    ...
    public void testFlattenMap3() throws IOException {
        ...
        @Test
    public void testFlattenMap4() throws IOException {
        Map aMap = JSONUtil.json2map("{\"test\":[{\"subject\":{\"value\":null,\"type\":\"A\",\"quoted\":\"{\\\"wow!\\\"}\",\"valid\":true, \"tags\":[1, 1.5, false, \"Geronimo\"]}},{\"object\":{\"value\":2,\"type\":\"B\",\"valid\":true, \"tags\":[1, 1.7, true, \"Hiawatha\"]}}]}");
        System.out.println(aMap);
        Map aFlatMap = new OddUtil().flatten(aMap);
        System.out.println(aFlatMap);
        assertTrue(aFlatMap.get("test.1.object.valid").equals("true"));
        assertTrue(aFlatMap.get("test.0.subject.quoted").equals("\"{\\\"wow!\\\"}\""));
    }
    ...
    public void testJson2csv() throws IOException {
        ...
        String case2 = "{\"test\":[{\"subject\":{\"value\":3,\"type\":\"C\",\"valid\":true, \"tags\":[1, 1.5, false, \"Geronimo\"]}},{\"object\":{\"value\":2,\"type\":\"B\",\"valid\":true, \"tags\":[1, 1.7, true, \"Hiawathb\"]}}]}";
        ArrayList cases = new ArrayList();
        cases.add(case1);
        cases.add(case2);
        String csv = new JSONUtil().json2csv(cases);
        System.out.println(csv);
        String compare = "test.0.subject.tags,test.0.subject.type,test.0.subject.valid,test.0.subject.value,test.1.object.tags,test.1.object.type,test.1.object.valid,test.1.object.value,\n" +
                "\"[1, 1.5, false, Geronimo]\",A,true,1,\"[1, 1.7, true, Hiawatha]\",B,true,2,\n" +
                "\"[1, 1.5, false, Geronimo]\",C,true,3,\"[1, 1.7, true, Hiawathb]\",B,true,2,\n";
...
//        assertEquals("test.0.subject.tags,test.0.subject.type,test.0.subject.valid,test.0.subject.value,test.1.object.tags,test.1.object.type,test.1.object.valid,test.1.object.value,\n\"[1, 1.5, false, Geronimo]\",\"\\\"\\\\\\\"A\\\\\\\"\\\"\",true,1,\"[1, 1.7, true, Hiawatha]\",B,true,2,\n\"[1, 1.5, false, Geronimo]\",C,true,3,\"[1, 1.7, true, Hiawatha]\",B,true,2,\n", csv);
    ...
    public void testEscapeQuotes(){
        String s = "{\"a\":1}";
        String s2 = new OddUtil().escapeQuotes(s);
        assertEquals("{\\\"a\\\":1}", s2);
    }
